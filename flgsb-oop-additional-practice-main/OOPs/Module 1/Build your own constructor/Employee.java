/**
 * Employee class para demonstrar encapsulamento - IBM OOP Java Course.
 *
...
public class Employee implements Cloneable {
    ...
    public void displayDetails() {
        ...
        System.out.println("Salário Mensal: R$" + this.salary);
        System.out.println("Salário Anual: R$" + this.calculateAnnualSalary());
    }
